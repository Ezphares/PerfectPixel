...
public:
    ...
    static void PNGImageLoaderFunction(
        char *data,
        size_t dataSize,
        void **target,
...
public:
    static PNGImage fromFile(
        const std::string &filename, bool switchRgb = false, bool vflip = true);

    static void FromSimpleBuffer(
        PNGImage *out_image,
        char *buffer,
        size_t bufferSize,
        bool bgr,
        bool vflip);
    static void ReadFromSimpleBuffer(
