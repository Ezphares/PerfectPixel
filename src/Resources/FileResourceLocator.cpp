...
namespace perfectpixel { namespace resources {
	...
	bool FileResourceLocator::locate(int32_t type, int32_t id, char **out_buffer, size_t *out_size)
	{
	...
	void FileResourceLocator::insert(int32_t type, int32_t id, const std::string &hint)
	{
