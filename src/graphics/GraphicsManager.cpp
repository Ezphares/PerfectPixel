...
void GraphicsManager::drawAll(double deltaT)
{
    ...
    std::sort(
        m_softAlpha.begin(),
        m_softAlpha.end(),
        &GraphicsManager::compSortSoftalpha);
...
void GraphicsManager::drawSpriteComponent(ecs::Entity entity)
{
    ...
    {
        sprite
            = *SpriteComponent::SpriteResource(entity).get<resources::Sprite>();
    }
...
void GraphicsManager::addSpriteToBuffer(
...
void GraphicsManager::addSpriteVertexToBuffer(
...
void GraphicsManager::drawSpriteList(
...
bool GraphicsManager::isStateCompatible(
...
void GraphicsManager::setCompatibleState(
...
GraphicsManager::getImageTexture(resources::Resource imageResource)
{
...
bool GraphicsManager::compSortSoftalpha(
